...
export { default as output } from "./output"            // -o
export { default as purge } from "./purge"              // -p
export { default as resume } from "./resume"            // -r
export { default as subtitles } from "./subtitles"      // -s
export { default as title } from "./title"              // -t
